# ====================================================================================
# Setup Project
PROJECT_NAME := provider-mybadmrprovider
...
IMAGES = provider-mybadmrprovider
...
XPKGS = provider-mybadmrprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-mybadmrprovider: do.build.images
...
# This target prepares repo for your provider by replacing all "mybadmrprovider"
