...
import (
	...
	badmr "github.com/crossplane/provider-mybadmrprovider/apis/badmr/v1"
	apisv1alpha1 "github.com/crossplane/provider-mybadmrprovider/apis/v1alpha1"
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(badmr.MyTypeGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(badmr.MyTypeGroupVersionKind),
